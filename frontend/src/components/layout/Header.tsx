...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full bg-black/75 backdrop-blur-md border-b border-[#1f1f23]/80 sticky top-0 z-40 text-[#ededed]">
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 h-13">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-7 h-7 rounded-lg bg-[#0a0a0a]/90 border border-[#222226] flex items-center justify-center relative shadow-xs">
          ...
          {/* Project Breadcrumb */}
          <div className="hidden sm:flex items-center gap-2 text-xs font-medium text-zinc-300 px-2 py-1 rounded-md hover:bg-white/5 transition cursor-pointer">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#0a0a0a]/80 border border-[#222226] text-[11px] font-mono">
            <span
          ...
          <button
            ...
            className="p-1.5 rounded-md text-zinc-400 hover:text-white hover:bg-white/5 transition border border-transparent hover:border-[#222226] cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium bg-[#0e0e11]/90 hover:bg-[#18181b] text-zinc-300 hover:text-white border border-[#222226] transition cursor-pointer"
          >
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-medium text-zinc-400 hover:text-white hover:bg-white/5 border border-transparent hover:border-[#222226] transition cursor-pointer"
          >
          ...
          <div className="relative">
            ...
            {isUserMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-[#0a0a0a]/95 backdrop-blur-xl border border-[#27272a] rounded-xl shadow-2xl py-1.5 z-50 text-xs font-medium animate-in fade-in zoom-in-95">
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 hover:bg-white/10 text-zinc-300 hover:text-white transition flex items-center gap-2 cursor-pointer"
                >
